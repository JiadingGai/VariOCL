; ModuleID = 'kernel_d4561824e5f62cb6141769bcc261b7f9.a.c'
...
entry:
  ...
  %call = call i32 (i32*, i32, i32*, ...)* bitcast (i32 (...)* @compute_sum_with_localmem to i32 (i32*, i32, i32*, ...)*)(i32* %arraydecay, i32 %1, i32* %sum)
