...
@.str = private unnamed_addr constant [10 x i8] c"\0A(%d,%d)\0A\00", align 1
...
entry:
  ...
  %call = call i32 (i32*, i32*, ...)* bitcast (i32 (...)* @local_memtest to i32 (i32*, i32*, ...)*)(i32* %arraydecay, i32* %arraydecay1)
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx3 = getelementptr inbounds [8 x i32]* %B, i32 0, i64 %idxprom2
  %6 = load i32* %arrayidx3, align 4
  %call4 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i32 %4, i32 %6)
  br label %for.inc
