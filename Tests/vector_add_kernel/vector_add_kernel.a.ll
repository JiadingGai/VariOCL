; ModuleID = 'vector_add_kernel.a.c'
...
@main.B = private unnamed_addr constant [8 x i32] [i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1], align 16
...
entry:
  ...
  %call = call i32 (i32*, i32*, i32*, i32, ...)* bitcast (i32 (...)* @vector_add to i32 (i32*, i32*, i32*, i32, ...)*)(i32* %arraydecay, i32* %arraydecay1, i32* %arraydecay2, i32 %3)
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [8 x i32]* %C, i32 0, i64 %idxprom
  %6 = load i32* %arrayidx, align 4
  %call3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %6)
  br label %for.inc
