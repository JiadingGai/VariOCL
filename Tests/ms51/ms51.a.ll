...
@.str = private unnamed_addr constant [7 x i8] c"\0A(%d)\0A\00", align 1
...
entry:
  ...
  %call = call i32 (i32*, i32*, i32, ...)* bitcast (i32 (...)* @b to i32 (i32*, i32*, i32, ...)*)(i32* %arraydecay, i32* %arraydecay1, i32 %2)
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [8 x i32]* %B, i32 0, i64 %idxprom
  %5 = load i32* %arrayidx, align 4
  %call2 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([7 x i8]* @.str, i32 0, i32 0), i32 %5)
  br label %for.inc
